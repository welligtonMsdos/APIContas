namespace APIContas.Enum;

public static class EMensagem
{
    public const string ID_ZERADO = "Id não poder ser zerado";
    ...
    public const string ELEMENTO_INATIVADO = "Elemento inativado";
}
